// Meal Analysis Service — Claude Vision-based food recognition and macro estimation
import type { MealAnalysisResult } from '../types/api.js'
...
export async function analyzeMealPhoto(imageBase64: string, mimeType: string = 'image/jpeg'): Promise<MealAnalysisResult> {
  ...
  const result: MealAnalysisResult = JSON.parse(jsonMatch[0])
